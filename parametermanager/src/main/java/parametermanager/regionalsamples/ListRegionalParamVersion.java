 ...
 */
public class ListRegionalParamVersion {

    /**
     * Lists all versions of a specified parameter.
     *
     * @param projectId    The ID of the project where the parameter is located.
     * @param locationId   The ID of the region where the parameter is located.
     * @param parameterId  The ID of the parameter for which versions are to be listed.
     ...
     */
    public static ListParameterVersionsPagedResponse listRegionalParamVersion(String projectId, String locationId, String parameterId) throws IOException {
        ...
        try (ParameterManagerClient client = ParameterManagerClient.create(parameterManagerSettings)) {
            ...
            response.iterateAll().forEach(version -> System.out.printf("Parameter version: %s, Disabled: %s\n", version.getName(), version.getDisabled()));
    ...
    public static void main(String[] args) throws IOException {
        ...
        listRegionalParamVersion(projectId, locationId, parameterId);
    }
}
