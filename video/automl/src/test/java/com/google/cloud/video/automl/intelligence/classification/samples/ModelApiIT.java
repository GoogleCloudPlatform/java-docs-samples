...
public class ModelApiIT {
  // TODO(developer): Change PROJECT_ID, COMPUTE_REGION and DATASET_ID before running the test
  // cases.
  private static final String PROJECT_ID = "java-docs-samples-testing";
  private static final String COMPUTE_REGION = "us-central1";
  private static final String FILTER = "videoClassificationModelMetadata:*";
  private static final String DATASET_ID = "VCN5604078825378938880";
  private static final String MODEL_NAME = "test_video_model";
