 ...
 * package exec:java
 * -Dexec.mainClass='com.google.cloud.video.automl.intelligence.classification.samples.DatasetApi'
...
public class DatasetApi {
  ...
  public void argsHelper(String[] args)
    ...
    listDatasetsParser
        .addArgument("filter")
        .nargs("?")
        .setDefault("video_classification_dataset_metadata:*");
    ...
    importDataParser
        .addArgument("path")
        .nargs("?")
        .setDefault("gs://automl-video-demo-data/hmdb_split1.csv");
