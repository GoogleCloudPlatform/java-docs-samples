...
public class DicomStoreExport {
  ...
  public static void dicomStoreExport(String dicomStoreName, String gcsPath) throws IOException {
    // String dicomStoreName =
    //    String.format(
    //        DICOM_NAME, "your-project-id", "your-region-id", "your-dataset-id", "your-dicom-id");
    // String gcsPath = "gs://your-bucket-id/path/to/destination/dir"
    ...
    GoogleCloudHealthcareV1beta1DicomGcsDestination gcsDestination =
        new GoogleCloudHealthcareV1beta1DicomGcsDestination().setUriPrefix(gcsPath);
