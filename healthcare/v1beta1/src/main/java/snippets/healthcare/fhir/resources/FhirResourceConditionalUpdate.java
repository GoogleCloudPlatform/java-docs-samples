...
public class FhirResourceConditionalUpdate {
  ...
  public static void conditionalUpdateFhirResource(String resourceName) throws IOException {
    // String resourceName =
    //    String.format(
    ...
    Fhir.ConditionalUpdateResource request =
        client
            .projects()
            .locations()
            .datasets()
            .fhirStores()
            .fhir()
            .conditionalUpdateResource(resourceName, resourceType, resource);

    // Execute the request and process the results.
    resource = request.execute();
    System.out.println("FHIR resource conditionally replaced: \n" + resource.toPrettyString());
  }
