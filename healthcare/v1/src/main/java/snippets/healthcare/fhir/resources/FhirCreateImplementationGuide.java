...
public class FhirCreateImplementationGuide {
  ...
  public static void main(String[] args) throws IOException, URISyntaxException {
    ...
    fhirCreateImplementationGuide(projectId, location, datasetId, fhirStoreId, filePath);
  }

  // Creates a FHIR ImplementationGuide resource in an existing FHIR store.
  public static void fhirCreateImplementationGuide(
