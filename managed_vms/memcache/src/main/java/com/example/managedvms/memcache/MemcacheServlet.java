...
package com.example.managedvms.memcache;
...
public class MemcacheServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException,
      ServletException {
    String addr =
        System.getenv().containsKey("MEMCACHE_PORT_11211_TCP_ADDR")
            ? System.getenv("MEMCACHE_PORT_11211_TCP_ADDR") : "localhost";
    String port =
        System.getenv().containsKey("MEMCACHE_PORT_11211_TCP_ADDR")
            ? System.getenv("MEMCACHE_PORT_11211_TCP_PORT") : "11211";
    String key = "count";
