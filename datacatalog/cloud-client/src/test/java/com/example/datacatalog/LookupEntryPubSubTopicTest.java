...
public class LookupEntryPubSubTopicTest {
  ...
  public void testLookupPubSubTopic() {
    LookupEntryPubSubTopic.main(PUBSUB_PROJECT, PUBSUB_TOPIC);
  ...
  public void testLookupPubSubTopicSqlResource() {
    LookupEntryPubSubTopic.main(PUBSUB_PROJECT, PUBSUB_TOPIC, "-lookupBySqlResource");
    String got = bout.toString();
    assertThat(got)
        .containsMatch(
            "projects/" + PUBSUB_PROJECT + "/locations/.+?/entryGroups/@pubsub/entries/.+?$");
