...
public class LookupEntryBigQueryTableTest {
  ...
  public void testLookupEntryBigQueryTable() {
    LookupEntryBigQueryTable.main(BIGQUERY_PROJECT, BIGQUERY_DATASET, BIGQUERY_TABLE);
  ...
  @Test
  public void testLookupEntryBigQueryTableSqlResource() {
    LookupEntryBigQueryTable.main(
        BIGQUERY_PROJECT, BIGQUERY_DATASET, BIGQUERY_TABLE, "-lookupBySqlResource");
    String got = bout.toString();
    assertThat(got)
        .containsMatch(
            "projects/" + BIGQUERY_PROJECT + "/locations/.+?/entryGroups/@bigquery/entries/.+?$");
