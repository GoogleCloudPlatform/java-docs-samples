...
public class UpdateRegionalSecretRotation {
  ...
  public static void main(String[] args) throws IOException {
    ...
    updateRegionalSecretRotation(projectId, locationId, secretId, rotationPeriodSeconds, 
        topicName);
  }

  // Update an existing regional secret with a new rotation policy.
  public static Secret updateRegionalSecretRotation(
