...
public class CreateRegionalSecretWithTopic {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createRegionalSecretWithTopic(projectId, locationId, secretId, topicName);
  }

  // Create a new regional secret with a Pub/Sub topic for notifications.
  public static Secret createRegionalSecretWithTopic(
      String projectId, String locationId, String secretId, String topicName) 
      throws IOException {
    ...
    try (SecretManagerServiceClient client = 
      ...
      // Build the regional secret to create with topic.
      Secret secret =
          Secret.newBuilder()
              .addTopics(topic)
              .build();
