...
public class DeleteRegionalSecretRotation {
  ...
  public static void main(String[] args) throws IOException {
    ...
    deleteRegionalSecretRotation(projectId, locationId, secretId);
  }

  // Delete the rotation policy from an existing regional secret.
  public static Secret deleteRegionalSecretRotation(
