...
public class ManageDataSnippetsIT extends BaseIntegrationTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    manageDataSnippets = new ManageDataSnippets(database);
  }
  ...
  public void testAddDataWithDifferentDataTypes() throws Exception {
    ...
    DocumentReference docRef = database.collection("data").document("one");
  ...
  public void testAddDocWithAutoGenId() throws Exception {
    ...
    DocumentReference docRef = database.collection("cities").document(autoId);
    assertTrue(Objects.equals(city, getDocumentDataAsCity(docRef)));
  }
  ...
  public void testUpdateNestedFields() throws Exception {
    ...
    DocumentReference docRef = database.collection("users").document("frank");
  ...
  public void testDeleteDocument() throws Exception {
    ...
    getDocumentDataAsMap(database.collection("cities").document("DC"));
  }
  ...
  public void testWriteBatchIsSuccessful() throws Exception {
    ...
    CollectionReference collection = database.collection("cities");
  ...
  public static void tearDown() throws Exception {
    manageDataSnippets.deleteCollection(database.collection("cities"), 10);
    manageDataSnippets.deleteCollection(database.collection("users"), 10);
  }
}
