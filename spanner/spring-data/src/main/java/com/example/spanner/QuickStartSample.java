...
public class QuickStartSample implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    */
    ...
    LOG.info("(SpannerTemplateSample): Running a query and an update with a timeout.");
    spannerTemplateSample.runTemplateTimeoutExample(singer);

    /*
     This call uses queries defined in SingerRepository. The implementations of those queries
     are generated by Spring Data Cloud Spanner. These queries can also use timeouts.
    */
    LOG.info("(SpannerRepositorySample): Running queries with timeouts.");
    spannerRepositorySample.runRepositoryTimeoutExample();
