  ...
  static void listModelEvaluations(
    ...
    try (AutoMlClient client = AutoMlClient.create()) {
      ...
      for (ModelEvaluation element :
        ...
        System.out.println(
            String
                .format("Model evaluation annotation spec Id: %s", element.getAnnotationSpecId()));
        System.out.println(
            String
                .format("Model evaluation example count: %s", element.getEvaluatedExampleCount()));
        System.out.println(
        ...
        for (ConfidenceMetricsEntry confidenceMetricsEntry : confidenceMetricsEntries) {
          ...
          System.out.println(
              String
                  .format("\t\tModel precision: %.2f ", confidenceMetricsEntry.getPrecision() * 100)
                  + '%');
          System.out.println(
