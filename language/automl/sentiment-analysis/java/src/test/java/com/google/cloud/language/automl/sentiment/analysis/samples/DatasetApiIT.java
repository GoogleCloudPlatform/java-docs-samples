...
import com.google.cloud.language.automl.sentiment.analysis.samples.DatasetApi;
...
public class DatasetApiIT {
  ...
  public void testCreateImportDeleteDataset()
    ...
    // Act
    DatasetApi.createDataset(PROJECT_ID, COMPUTE_REGION, DATASET_NAME, SENTIMENT_MAX);
