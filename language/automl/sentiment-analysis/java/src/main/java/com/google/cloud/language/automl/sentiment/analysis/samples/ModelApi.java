 ...
 * -Dexec.mainClass='com.google.cloud.language.automl.sentiment.analysis.samples.ModelApi'
...
public class ModelApi {
  ...
  public void argsHelper(String[] args)
    ...
    listModelsParser.addArgument("filter").nargs("?").setDefault("textSentimentModelMetadata:*");
