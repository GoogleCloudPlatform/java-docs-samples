...
public class JobServiceQuickstart {
  ...
  private static JobService jobService = createJobService(generateCredential());

  private static JobService createJobService(GoogleCredential credential) {
    String url = "https://jobs.googleapis.com";
    return new JobService.Builder(
