 ...
 * exec:java -Dexec.mainClass='com.google.cloud.vision.automl.object.detection.samples.DatasetApi'
...
public class DatasetApi {
  ...
  public static void createDataset(String projectId, String computeRegion, String datasetName)
    ...
    Dataset myDataset =
        Dataset.newBuilder()
            ...
            .setImageObjectDetectionDatasetMetadata(imageObjectDetectionDatasetMetadata)
            .build();
    ...
    System.out.println("Image object detection dataset specification:");
    System.out.print(String.format("\t%s", dataset.getImageObjectDetectionDatasetMetadata()));
   ...
   * @param path the Google Cloud Storage URIs. Target files must be in AutoML Vision Object
  ...
  // [START automl_vision_object_detection_delete_dataset]
  /**
  ...
  public void argsHelper(String[] args)
    ...
    listDatasetsParser
        .addArgument("filter")
        .nargs("?")
        .setDefault("imageObjectDetectionDatasetMetadata:*");
    ...
    importDataParser
        .addArgument("path")
        .nargs("?")
        .setDefault("gs://cloud-ml-data/img/openimage/csv/salads_ml_use.csv");
