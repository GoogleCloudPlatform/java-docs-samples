...
public class DeIdentifyWithSimpleWordList {
  ...
  public static void deidentifyWithSimplaWordList() throws IOException {
    // TODO(developer): Replace these variables before running the sample.
    String projectId = "your-project-id";
    String textToDeIdentify = "Patient was seen in RM-YELLOW then transferred to rm green.";
    deidentifyWithSimplaWordList(projectId, textToDeIdentify);
  }

  public static void deidentifyWithSimplaWordList(String projectId, String textToDeIdentify)
      throws IOException {
