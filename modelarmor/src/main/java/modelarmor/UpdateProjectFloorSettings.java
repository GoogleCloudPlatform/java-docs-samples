...
public class UpdateProjectFloorSettings {
  ...
  public static void main(String[] args) throws Exception {
    ...
    updateProjectFloorSettings(projectId);
  }

  public static void updateProjectFloorSettings(String projectId)
      throws Exception {

    try (ModelArmorClient client = ModelArmorClient.create()) {
      String name = FloorSettingName.of(projectId, "global").toString();

      FloorSetting projectFloorSettings = FloorSetting.newBuilder()
          .setName(name)
          .setFilterConfig(
