...
public class UpdateOrganizationsFloorSettings {

  public static void main(String[] args) throws Exception {
    // TODO(developer): Replace these variables before running the sample.
    String organizationId = "your-organization-id";

    updateOrganizationFloorSettings(organizationId);
  }

  public static void updateOrganizationFloorSettings(String organizationId) throws Exception {
    ...
    try (ModelArmorClient client = ModelArmorClient.create()) {
      ...
      FloorSetting organizationFloorSettings =
