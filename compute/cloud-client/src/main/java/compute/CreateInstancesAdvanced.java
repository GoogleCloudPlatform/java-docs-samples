...
// [START compute_instances_create_from_image]
     ...
     * @param boot         boolean flag indicating whether this disk should be used as a boot disk of an instance
     * @param sourceImage  source image to use when creating this disk. You must have read access to this disk. This can be one
     *                     of the publicly available images or an image from one of your projects.
     *                     This value uses the following format: "projects/{project_name}/global/images/{image_name}"
     *
     * @return AttachedDisk object configured to be created using the specified image.
     */
    private static AttachedDisk diskFromImage(String diskType, int diskSizeGb, boolean boot, String sourceImage) {
        AttachedDisk disk =
...
// [START compute_instances_create_from_snapshot]
     ...
     * @param diskSizeGb    size of the new disk in gigabytes
     * @param boot          boolean flag indicating whether this disk should be used as a boot disk of an instance
     * @param diskSnapshot  disk snapshot to use when creating this disk. You must have read access to this disk.
     ...
     */
    private static AttachedDisk diskFromSnapshot(String diskType, int diskSizeGb, boolean boot, String diskSnapshot) {
        AttachedDisk disk =
                AttachedDisk.newBuilder()
                        .setBoot(boot)
                        // Remember to set auto_delete to True if you want the disk to be deleted when you delete
...
// [START compute_instances_create_from_image]
     ...
     * @param disks         a list of compute_v1.AttachedDisk objects describing the disks
     *                      you want to attach to your new instance.
     * @param machineType   machine type of the VM being created. This value uses the
     *                      following format: "zones/{zone}/machineTypes/{type_name}".
     *                      For example: "zones/europe-west3-c/machineTypes/f1-micro"
     * @param network       name of the network you want the new instance to use.
     *                      For example: "global/networks/default" represents the network
     *                      named "default", which is created automatically for each project.
     * @param subnetwork    name of the subnetwork you want the new instance to use.
     *                      This value uses the following format:
     *                      "regions/{region}/subnetworks/{subnetwork_name}"
     *
     * @return Instance object.
     */
    private static Instance createWithDisks(String project, String zone, String instanceName, Vector<AttachedDisk> disks, String machineType, String network, String subnetwork)
        throws IOException, InterruptedException, ExecutionException {
...
// [START compute_instances_create_from_snapshot]
     ...
     * @param zone          name of the zone to create the instance in. For example: "us-west3-b"
     * @param instanceName  name of the new virtual machine (VM) instance.
     * @param snapshotName  link to the snapshot you want to use as the source of your
     *                      boot disk in the form of:
     *                      "projects/{project_name}/global/snapshots/{snapshot_name}"
     *
     * @return Instance object.
     */
...
// [START compute_instances_create_from_image]
     ...
     * @param zone              name of the zone to create the instance in. For example: "us-west3-b"
     * @param instanceName      name of the new virtual machine (VM) instance.
     * @param networkLink       name of the network you want the new instance to use.
     *                          For example: "global/networks/default" represents the network
     *                          named "default", which is created automatically for each project.
     * @param subnetworkLink    name of the subnetwork you want the new instance to use.
     *                          This value uses the following format:
     *                          "regions/{region}/subnetworks/{subnetwork_name}"
     *
     * @return Instance object.
