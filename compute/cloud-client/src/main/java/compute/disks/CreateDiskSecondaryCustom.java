...
public class CreateDiskSecondaryCustom {
  public static void main(String[] args)
    ...
    createDiskSecondaryCustom(primaryProjectId, secondaryProjectId, primaryDiskName,
  ...
  public static Disk createDiskSecondaryCustom(String primaryProjectId, String secondaryProjectId,
