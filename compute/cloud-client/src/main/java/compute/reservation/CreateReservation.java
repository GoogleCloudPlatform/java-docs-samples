...
public class CreateReservation {
  ...
  public static void main(String[] args)
    ...
    createReservation(projectId, reservationName, instanceTemplateName, numberOfVms, zone);
  }

  // Creates a reservation in a project for the instance template for the global region.
  public static void createReservation(String projectId, String reservationName,
    ...
    try (ReservationsClient reservationsClient = ReservationsClient.create();
         InstanceTemplatesClient templatesClient = InstanceTemplatesClient.create()) {

      // Get the instance template.
      InstanceTemplate instanceTemplate = templatesClient.get(projectId, instanceTemplateName);
