...
public class GetSecurityHealthAnalyticsCustomModule {
	...
	public static SecurityHealthAnalyticsCustomModule getSecurityHealthAnalyticsCustomModule(String parent,
			String customModuleId) throws IOException {
		...
		try (SecurityCenterManagementClient client = SecurityCenterManagementClient.create()) {
			...
			// create the request
			GetSecurityHealthAnalyticsCustomModuleRequest request = GetSecurityHealthAnalyticsCustomModuleRequest
					.newBuilder().setName(name).build();

			// calls the API
			SecurityHealthAnalyticsCustomModule response = client.getSecurityHealthAnalyticsCustomModule(request);

			//printing the complete response
			System.out.printf("SecurityHealthAnalyticsCustomModule response is : %s", response);
