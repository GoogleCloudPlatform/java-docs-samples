...
public class ListSecurityHealthAnalyticsCustomModules {
	...
	public static ListSecurityHealthAnalyticsCustomModulesPagedResponse listSecurityHealthAnalyticsCustomModules(
		...
		try (SecurityCenterManagementClient client = SecurityCenterManagementClient.create()) {
			...
			// create the request
			ListSecurityHealthAnalyticsCustomModulesRequest request = ListSecurityHealthAnalyticsCustomModulesRequest
					.newBuilder().setParent(parent).build();

			// calls the API
			ListSecurityHealthAnalyticsCustomModulesPagedResponse response = client
