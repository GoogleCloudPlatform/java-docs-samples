...
public class CreateSource {
   ...
   * <p>
   * This method sets up and creates a source in SCC, which can be used to group and identify
   * specific security findings generated by third-party scanners or processes. A source acts as a
   * logical container in SCC for security findings, allowing different tools and services to report
   * identified issues under the same organizational category.
   *
   * @param organizationId the identifier of the GCP organization where the source will be created
   * @return Source the source created in the Security Command Center
   * @throws IOException if an input/output error occurs during source creation
   */
