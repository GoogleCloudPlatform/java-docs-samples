...
public class DeleteNotification {
    public static void main(String[] args) throws IOException {
        ...
        deleteNotificationConfig(projectId, location,notificationConfigId);
    }
    // Delete a notification config.
    // Ensure the ServiceAccount has the "securitycenter.notification.delete" permission
    public static boolean deleteNotificationConfig(String projectId, String location,String notificationConfigId)
            throws IOException {
