...
public class SetUnmuteFindingV2 {
  ...
  public static void main(String[] args) {
    ...
    // orgId: Google Cloud Organization id.
    String orgId = "google-cloud-org-id";
    ...
    setUnmute(orgId, location, sourceId, findingId);
  }

  // Unmute an individual finding.
  // Unmuting a finding that isn't muted has no effect.
  // Various mute states are: MUTE_UNSPECIFIED/MUTE/UNMUTE.
  public static void setUnmute(String orgId, String location, String sourceId, String findingId) {
    ...
    try (SecurityCenterClient client = SecurityCenterClient.create()) {
      ...
      String findingPath = String.format("organizations/%s/sources/%s/locations/%s/findings/%s",
          orgId, sourceId, location, findingId);
