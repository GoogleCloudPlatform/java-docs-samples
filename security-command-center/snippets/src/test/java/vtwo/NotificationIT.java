...
public class NotificationIT {
    ...
    private static final String NOTIFICATION_RULE_CREATE = "random-notification-id-" + UUID.randomUUID();
    ...
    public static void setUp() throws IOException, InterruptedException {
        ...
        NotificationConfig result = CreateNotification.createNotificationConfig(PROJECT_ID, LOCATION, NOTIFICATION_TOPIC, NOTIFICATION_RULE_CREATE);
    ...
    public static void cleanUp() throws IOException {
        ...
        assertThat(stdOut.toString()).contains("Deleted Notification config: " + NOTIFICATION_RULE_CREATE);
    ...
    public void testGetNotificationRule() throws IOException {
        NotificationConfig notificationConfig = GetNotification.getNotificationConfig(PROJECT_ID, LOCATION, NOTIFICATION_RULE_CREATE);
    ...
    public void testUpdateNotificationRule() throws IOException {
        UpdateNotification.updateNotificationConfig(PROJECT_ID, LOCATION, NOTIFICATION_TOPIC, NOTIFICATION_RULE_CREATE);
        NotificationConfig notificationConfig = GetNotification.getNotificationConfig(PROJECT_ID, LOCATION, NOTIFICATION_RULE_CREATE);
