...
public class DeleteEntityTest {
  ...
  public void setUp() throws IOException, ExecutionException, InterruptedException {
    ...
    try (EntityTypesClient client = EntityTypesClient.create()) {
      ...
      Entity entity = Entity.newBuilder().setValue(ENTITY_VALUE).addAllSynonyms(SYNONYMS).build();
      Empty empty =
          client.batchCreateEntitiesAsync(entityTypeName, Collections.singletonList(entity)).get();
    }
  ...
  public void testDeleteEntity() throws Exception {
    ...
    EntityManagement.deleteEntity(PROJECT_ID, entityTypeId, ENTITY_VALUE);
  }
}
