...
public class GetDocumentTest {
  ...
  public void testGetDocument() throws Exception {
    DocumentName documentName =
        DocumentName.of(PROJECT_ID, TEST_KNOWLEDGE_BASE_ID, TEST_DOCUMENT_ID);
    DocumentManagement.getDocument(documentName.toString());
    String got = bout.toString();
    assertThat(got).contains(TEST_DOCUMENT_ID);
  }
}
