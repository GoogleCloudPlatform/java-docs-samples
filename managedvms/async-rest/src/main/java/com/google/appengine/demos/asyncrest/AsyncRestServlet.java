...
public class AsyncRestServlet extends AbstractRestServlet
{
    ...
    public void init(ServletConfig servletConfig) throws ServletException
    {
        ...
        _client = new HttpClient(sslContextFactory);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (results==null)
        {
            ...
            {
                _client.newRequest(restQuery(lat+","+longitude, radius, item)).method(HttpMethod.GET).send(
        ...
        out.print("<b>Asynchronous: Requesting "+sanitize(request.getParameter(ITEMS_PARAM))
        +" near "+(loc !=null? loc: "lat="+sanitize(request.getParameter(LATITUDE_PARAM))+" long="+sanitize(request.getParameter(LONGITUDE_PARAM)))
        +"</b><br/>");
