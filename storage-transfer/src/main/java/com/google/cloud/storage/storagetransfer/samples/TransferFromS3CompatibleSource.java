...
public class TransferFromS3CompatibleSource {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // The agent pool associated with the S3 compatible data source. If not provided, defaults to the
        // default agent
        ...
        transferFromS3CompatibleSource(projectId, sourceAgentPoolName, sourceBucketName, sourcePath, region, endpoint, protocol, requestModel, authMethod, gcsSinkBucket, gcsPath);
    }

    public static void transferFromS3CompatibleSource(
            String projectId, String sourceAgentPoolName, String sourceBucketName, String sourcePath, String region, String endpoint, NetworkProtocol protocol, RequestModel requestModel, AuthMethod authMethod, String gcsSinkBucket, String gcsPath)
            throws IOException {
                                ...
                                TransferSpec.newBuilder()
                                        ...
                                        .setAwsS3CompatibleDataSource(
                                                TransferTypes.AwsS3CompatibleData.newBuilder()
                                                        ...
                                                        .setPath(sourcePath)
                                                        .setS3Metadata(TransferTypes.S3CompatibleMetadata.newBuilder()
                                        ...
                                        .setGcsDataSink(GcsData.newBuilder().setBucketName(gcsSinkBucket).setPath(gcsPath).build()))
