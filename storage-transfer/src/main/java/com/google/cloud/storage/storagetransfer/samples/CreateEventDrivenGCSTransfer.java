...
public class CreateEventDrivenGCSTransfer {
    ...
    public static void createEventDrivenGcsTransfer(
            String projectId, String gcsSourceBucket, String gcsSinkBucket, String pubSubId) throws Exception {
        ...
        try (StorageTransferServiceClient storageTransfer = StorageTransferServiceClient.create()) {
                    ...
                    TransferTypes.TransferJob.newBuilder()
                            ...
                            .setTransferSpec(
                                    TransferTypes.TransferSpec.newBuilder()
                                            .setGcsDataSource(TransferTypes.GcsData.newBuilder().setBucketName(gcsSourceBucket))
            ...
            System.out.println(
                    "Created a transfer job between from " + gcsSourceBucket + " to " + gcsSinkBucket
                            + " subscribed to " + pubSubId + " with name " + response.getName());
        }
    }
}
