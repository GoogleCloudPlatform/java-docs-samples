...
public class DownloadToPosix {
    public static void downloadToPosix(String projectId, String sinkAgentPoolName, String gcsSourceBucket,
                                       String gcsSourcePath, String rootDirectory) throws IOException {
        // Your project id
        ...
        System.out.println("Created and ran a transfer job from " + gcsSourcePath + " to " + rootDirectory + " with " +
