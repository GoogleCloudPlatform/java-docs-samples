...
public final class CustomerMetadata extends RowDetails {
  ...
  /**
   * Constructs CustomerMetadata object.
   *
   * @param line a CustomerMetadata comma-seperated line
   */
  public CustomerMetadata(final String line) {
    super(line);
  }
   ...
   */
  public CustomerMetadata(final Result row) {
    super(row);
  }
