...
//     p.apply(GenerateSequence.from(0).withRate(1, new Duration(10)))
//         .apply(ParDo.of(new ReadFromTableFn(options)))
...
//   }
//
//   public static class ReadFromTableFn extends DoFn<Long, Entity> {
//
//     List<List<Float>> imageData = new ArrayList<>();
//     String[] keys;
//
//
//     public ReadFromTableFn(ReadDataOptions readDataOptions) {
//       super();
...
//
//     @ProcessElement
//     public void processElement(@Element Long word, OutputReceiver<Entity> out) {
...
//       int RANDOM_ID_BOUND = 100000;
//       return (long) random.nextInt(RANDOM_ID_BOUND) + 1;
//     }
//
//     // @ProcessElement
...
//     //
//     //   try {
//     //     // Scan with a filter that will only return the first key from each row. This filter
//     //    is used
