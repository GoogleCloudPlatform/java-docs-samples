...
public final class RenewLeaseRequest extends com.google.api.client.json.GenericJson {
  ...
  private String newLeaseDuration;
   ...
   * or CloudTasks.RenewLease.  This restriction is to check that the caller is renewing the correct
   * task.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   *
   * The maximum lease duration is 1 week.
   * @param newLeaseDuration newLeaseDuration or {@code null} for none
   */
  public RenewLeaseRequest setNewLeaseDuration(String newLeaseDuration) {
  ...
  @Override
  public RenewLeaseRequest set(String fieldName, Object value) {
    return (RenewLeaseRequest) super.set(fieldName, value);
  }

  @Override
  public RenewLeaseRequest clone() {
    return (RenewLeaseRequest) super.clone();
  }
