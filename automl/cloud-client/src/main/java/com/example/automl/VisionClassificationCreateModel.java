...
class VisionClassificationCreateModel {
  ...
  static void createModel(String projectId, String datasetId, String displayName)
    ...
    try (AutoMlClient client = AutoMlClient.create()) {
      ...
      // Set model metadata.
      ImageClassificationModelMetadata metadata = ImageClassificationModelMetadata.newBuilder()
              .setTrainBudgetMilliNodeHours(8)  // The train budget of creating this model, expressed in hours.
              .build();
      Model model =
              Model.newBuilder()
