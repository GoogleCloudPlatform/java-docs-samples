 ...
 */
// DO NOT EDIT! This is a generated sample ("RequestPaged",  "automl_video_object_tracking_list_datasets")
// sample-metadata:
//   title: List Datasets
//   description: List datasets and print each details of each dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlVideoObjectTrackingListDatasets [--args='[--project "[Google Cloud Project ID]"]']
...
public class AutomlVideoObjectTrackingListDatasets {
  ...
  public static void sampleListDatasets(String project) {
    try (AutoMlClient autoMlClient = AutoMlClient.create()) {
      ...
      String filter = "video_object_tracking_dataset_metadata:*";
