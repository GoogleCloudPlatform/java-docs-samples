 ...
 */
// DO NOT EDIT! This is a generated sample ("RequestPaged",  "automl_vision_list_datasets")
// sample-metadata:
//   title: List Datasets
//   description: List datasets and print each details of each dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlVisionListDatasets [--args='[--project "[Google Cloud Project ID]"]']
...
public class AutomlVisionListDatasets {
  ...
  public static void sampleListDatasets(String project) {
    try (AutoMlClient autoMlClient = AutoMlClient.create()) {
      ...
      String filter = "image_classification_dataset_metadata:*";
      ...
      for (Dataset responseItem : autoMlClient.listDatasets(request).iterateAll()) {
        ...
        // Print image classification type
        System.out.printf(
            "Image classification dataset metadata type: %s\n",
            dataset.getImageClassificationDatasetMetadata().getClassificationType());
      }
