 ...
 */
// DO NOT EDIT! This is a generated sample ("LongRunningRequestAsync",  "automl_video_object_tracking_delete_dataset")
// sample-metadata:
//   title: Delete Dataset
//   description: Delete Dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlVideoObjectTrackingDeleteDataset [--args='[--dataset_id "[Dataset ID]"] [--project "[Google Cloud Project ID]"]']
...
public class AutomlVideoObjectTrackingDeleteDataset {
