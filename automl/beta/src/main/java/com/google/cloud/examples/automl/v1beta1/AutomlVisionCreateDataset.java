...
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlVisionCreateDataset [--args='[--display_name "My_Dataset_Name_123"] [--project "[Google Cloud Project ID]"]']
...
public class AutomlVisionCreateDataset {
