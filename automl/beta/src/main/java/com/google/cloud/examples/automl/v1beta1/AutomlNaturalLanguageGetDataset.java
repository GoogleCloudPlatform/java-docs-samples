 ...
 */
// DO NOT EDIT! This is a generated sample ("Request",  "automl_natural_language_get_dataset")
// sample-metadata:
//   title: Get Dataset
//   description: Get dataset and print dataset details
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlNaturalLanguageGetDataset [--args='[--dataset_id "[Dataset ID]"] [--project "[Google Cloud Project ID]"]']
...
public class AutomlNaturalLanguageGetDataset {
