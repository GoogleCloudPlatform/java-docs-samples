 ...
 */
// DO NOT EDIT! This is a generated sample ("Request",  "automl_translation_get_dataset")
// sample-metadata:
//   title: Get Dataset
//   description: Get dataset and print dataset details
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlTranslationGetDataset [--args='[--dataset_id "[Dataset ID]"] [--project "[Google Cloud Project ID]"]']
...
public class AutomlTranslationGetDataset {
