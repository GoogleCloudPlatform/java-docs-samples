 ...
 */
// DO NOT EDIT! This is a generated sample ("RequestPaged",  "automl_natural_language_entity_list_datasets")
// sample-metadata:
//   title: List Datasets
//   description: List datasets and print each details of each dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlNaturalLanguageEntityListDatasets [--args='[--project "[Google Cloud Project ID]"]']
...
public class AutomlNaturalLanguageEntityListDatasets {
  ...
  public static void sampleListDatasets(String project) {
    try (AutoMlClient autoMlClient = AutoMlClient.create()) {
      ...
      // This filters for Datasets which have text_extraction_dataset_metadata.
      String filter = "text_extraction_dataset_metadata:*";
