 ...
 */
// DO NOT EDIT! This is a generated sample ("Request",  "automl_translation_create_dataset")
// sample-metadata:
//   title: Create Dataset
//   description: Create Dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlTranslationCreateDataset [--args='[--display_name "My_Dataset_Name_123"] [--project "[Google Cloud Project ID]"]']
