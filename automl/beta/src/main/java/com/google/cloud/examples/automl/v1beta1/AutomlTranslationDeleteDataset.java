 ...
 */
// DO NOT EDIT! This is a generated sample ("LongRunningRequestAsync",  "automl_translation_delete_dataset")
// sample-metadata:
//   title: Delete Dataset
//   description: Delete Dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlTranslationDeleteDataset [--args='[--dataset_id "[Dataset ID]"] [--project "[Google Cloud Project ID]"]']
...
public class AutomlTranslationDeleteDataset {
