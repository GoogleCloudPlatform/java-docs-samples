 ...
 */
// DO NOT EDIT! This is a generated sample ("RequestPaged",  "automl_natural_language_sentiment_list_datasets")
// sample-metadata:
//   title: List Datasets
//   description: List datasets and print each details of each dataset
//   usage: gradle run -PmainClass=com.google.cloud.examples.automl.v1beta1.AutomlNaturalLanguageSentimentListDatasets [--args='[--project "[Google Cloud Project ID]"]']
...
public class AutomlNaturalLanguageSentimentListDatasets {
  ...
  public static void sampleListDatasets(String project) {
    try (AutoMlClient autoMlClient = AutoMlClient.create()) {
      ...
      String filter = "text_sentiment_dataset_metadata:*";
