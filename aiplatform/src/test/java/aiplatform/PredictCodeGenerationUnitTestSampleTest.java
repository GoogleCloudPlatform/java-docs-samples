...
public class PredictCodeGenerationUnitTestSampleTest {
  ...
  @Test
  public void testPredictUnitTest() throws IOException {
    // Act
    PredictCodeGenerationUnitTestSample.predictUnitTest(
