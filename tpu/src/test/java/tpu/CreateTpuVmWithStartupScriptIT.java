...
public class CreateTpuVmWithStartupScriptIT {
  ...
  private static final String TPU_VM_NAME = "test-tpu-with-script-" + javaVersion + "-"
  ...
  public void testCreateTpuVmWithStartupScript()
    ...
    CreateTpuVmWithStartupScript.createTpuVmWithStartupScript(
        PROJECT_ID, ZONE, TPU_VM_NAME, ACCELERATOR_TYPE, VERSION);
