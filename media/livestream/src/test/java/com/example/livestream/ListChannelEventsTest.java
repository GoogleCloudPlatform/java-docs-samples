...
public class ListChannelEventsTest {
  ...
  @Test
  public void test_ListChannelEvents() throws Exception {
    ListChannelEvents.listChannelEvents(PROJECT_ID, LOCATION, CHANNEL_ID);
