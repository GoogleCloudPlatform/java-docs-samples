...
public class GetAssetTest {
  ...
  private static String ASSET_NAME;
  ...
  public void beforeTest()
    ...
    ASSET_NAME =
        String.format("projects/%s/locations/%s/assets/%s", PROJECT_ID, LOCATION, ASSET_ID);
    try {
  ...
  @Test
  public void test_GetAsset() throws IOException {
    GetAsset.getAsset(PROJECT_ID, LOCATION, ASSET_ID);
    String output = bout.toString();
    assertThat(output, containsString(ASSET_NAME));
    bout.reset();
  }
