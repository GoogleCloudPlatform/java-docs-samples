...
import com.google.cloud.video.livestream.v1.RetentionConfig;
...
public class CreateChannel {
  ...
  // Creates a channel that ingests the input stream through an input endpoint, transcodes the
  // input stream into multiple renditions, and publishes output live streams in certain formats in
                      ...
                      .setRetentionConfig(
                          RetentionConfig.newBuilder()
                              .setRetentionWindowDuration(
                                  Duration.newBuilder().setSeconds(86400).build())
                              .build()))
              .build();
