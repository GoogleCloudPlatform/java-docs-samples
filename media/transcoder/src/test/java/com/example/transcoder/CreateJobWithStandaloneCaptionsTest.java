...
public class CreateJobWithStandaloneCaptionsTest {
  ...
  private static final String TEST_CAPTIONS_NAME = "caption.srt";
  ...
  private static final String OUTPUT_URI_FOR_AD_HOC = "gs://" + BUCKET_NAME + "/test-output-standalone-captions/";
  ...
  public void beforeTest() throws IOException {
    ...
    blobId = BlobId.of(BUCKET_NAME, TEST_CAPTIONS_NAME);
    blobInfo = BlobInfo.newBuilder(blobId).build();
    path = Paths.get(TEST_CAPTIONS_PATH);
    storage.create(blobInfo, Files.readAllBytes(path));
  ...
  @Test
  public void test_CreateJobWithStandaloneCaptions() throws Exception {
    String jobName = String.format("projects/%s/locations/%s/jobs/", PROJECT_NUMBER, LOCATION);
    CreateJobWithStandaloneCaptions.createJobWithStandaloneCaptions(
        PROJECT_ID, LOCATION, INPUT_URI, CAPTIONS_URI, OUTPUT_URI_FOR_AD_HOC);
