...
public class CreateJobWithPeriodicImagesSpritesheetTest {
  ...
  private static final String OUTPUT_DIR = "test-output-periodic-spritesheet/";
  private static final String OUTPUT_URI_FOR_PERIODIC_SPRITESHEET =
  ...
  @Test
  public void test_CreateJobWithPeriodicImagesSpritesheet() throws Exception {
    String jobName = String.format("projects/%s/locations/%s/jobs/", PROJECT_NUMBER, LOCATION);
    CreateJobWithPeriodicImagesSpritesheet.createJobWithPeriodicImagesSpritesheet(
    ...
    assertTrue(
        ...
        checkFileExists(
            BUCKET_NAME,
            OUTPUT_DIR
                + CreateJobWithPeriodicImagesSpritesheet.smallSpritesheetFilePrefix
                + CreateJobWithPeriodicImagesSpritesheet.spritesheetFileSuffix));
    assertTrue(
        "Check that large spritesheet exists.",
        checkFileExists(
            BUCKET_NAME,
            OUTPUT_DIR
                + CreateJobWithPeriodicImagesSpritesheet.largeSpritesheetFilePrefix
                + CreateJobWithPeriodicImagesSpritesheet.spritesheetFileSuffix));
  }
