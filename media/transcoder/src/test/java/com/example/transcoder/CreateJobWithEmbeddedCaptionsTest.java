...
public class CreateJobWithEmbeddedCaptionsTest {
  ...
  @Test
  public void test_CreateJobWithEmbeddedCaptions() throws Exception {
    String jobName = String.format("projects/%s/locations/%s/jobs/", PROJECT_NUMBER, LOCATION);
    CreateJobWithEmbeddedCaptions.createJobWithEmbeddedCaptions(
