...
import com.example.transcoder.ListJobTemplates;
...
public class ListJobTemplateTest {
  ...
  @Test
  public void test_ListJobTemplates() throws IOException {
    try {
      ListJobTemplates.listJobTemplates(PROJECT_ID, LOCATION);
    } catch (GoogleJsonResponseException gjre) {
    }
