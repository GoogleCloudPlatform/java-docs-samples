...
public class ListVodAdTagDetailsTest {
  ...
  public void beforeTest() throws IOException {
    ...
    SESSION_NAME = String.format("locations/%s/vodSessions/%s/", LOCATION, SESSION_ID);
    bout.reset();
  }

  @Test
  public void test_ListVodAdTagDetailsTest() throws IOException {
    ListVodAdTagDetails.listVodAdTagDetails(PROJECT_ID, LOCATION, SESSION_ID);
    String output = bout.toString();
    assertThat(output, containsString(SESSION_NAME.concat("vodAdTagDetails/")));
    bout.reset();
  }
