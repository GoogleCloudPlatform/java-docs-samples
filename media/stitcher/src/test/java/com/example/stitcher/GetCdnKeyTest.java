...
public class GetCdnKeyTest {
  ...
  public void test_GetCdnKey() throws IOException {
    // Cloud CDN key
    GetCdnKey.getCdnKey(PROJECT_ID, TestUtils.LOCATION, CLOUD_CDN_KEY_ID);
    String output = bout.toString();
    assertThat(output, containsString(CLOUD_CDN_KEY_NAME));
    bout.reset();

    // Media CDN key
    GetCdnKey.getCdnKey(PROJECT_ID, TestUtils.LOCATION, MEDIA_CDN_KEY_ID);
    output = bout.toString();
    assertThat(output, containsString(MEDIA_CDN_KEY_NAME));
    bout.reset();

    // Akamai CDN key
    GetCdnKey.getCdnKey(PROJECT_ID, TestUtils.LOCATION, AKAMAI_KEY_ID);
    output = bout.toString();
