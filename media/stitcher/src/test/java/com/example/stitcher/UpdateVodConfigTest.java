...
public class UpdateVodConfigTest {
  ...
  private static final String UPDATED_VOD_URI =
  ...
  @Test
  public void test_UpdateVodConfig()
      throws IOException, ExecutionException, InterruptedException, TimeoutException {
    UpdateVodConfig.updateVodConfig(PROJECT_ID, TestUtils.LOCATION, VOD_CONFIG_ID, UPDATED_VOD_URI);
