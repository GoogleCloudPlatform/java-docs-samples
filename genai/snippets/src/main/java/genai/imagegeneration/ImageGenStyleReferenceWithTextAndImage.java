    ...
    try (Client client = Client.builder().location("global").vertexAI(true).build()) {
      ...
      GenerateContentResponse response =
          client.models.generateContent(
              modelId,
              Content.fromParts(
                  Part.fromUri("gs://cloud-samples-data/generative-ai/image/neon.png", "image/png"),
                  Part.fromText(
                      "generate an image of a neon sign with the words: have a great day")),
              config);
      ...
      String objectName =
          slashIdx > 0
              ? gcsPath.substring(slashIdx + 1) + "/style_customization.png"
              : "style_customization.png";
