    ...
    try (Client client = Client.builder().location("global").vertexAI(true).build()) {
      ...
      GenerateContentResponse response =
          client.models.generateContent(
              ...
              Content.fromParts(
                  Part.fromUri(
                      "gs://cloud-samples-data/generative-ai/image/car_scribble.png", "image/png"),
                  Part.fromText("an oil painting showing the side of a red car")),
              config);
      ...
      String objectName =
          slashIdx > 0
              ? gcsPath.substring(slashIdx + 1) + "/scribble_customization.png"
              : "scribble_customization.png";
