...
public class BigQueryRunnerTest {
  ...
  @Mock private UnaryCallable<CreateMetricDescriptorRequest, MetricDescriptor> createMetricCallable;
  @Mock private UnaryCallable<CreateTimeSeriesRequest, Empty> createTimeSeriesCallable;
  @Mock private ListMetricDescriptorsPagedResponse listResponse;

  @Captor private ArgumentCaptor<CreateTimeSeriesRequest> createTimeSeriesRequest;
