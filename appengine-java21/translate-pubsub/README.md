# Google Cloud API Showcase: Using Cloud Pub/Sub & Translate on App Engine Standard Java 21 Environment
...
cd java-docs-samples/appengine-java21/translate-pubsub
```
