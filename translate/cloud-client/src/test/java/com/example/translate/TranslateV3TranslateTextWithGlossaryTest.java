...
public class TranslateV3TranslateTextWithGlossaryTest {
  ...
  public void testTranslateTextWithGlossary() {
    // Act
    TranslateV3TranslateTextWithGlossary.sampleTranslateTextWithGlossary(
            "account",
            "en",
            "ja",
            PROJECT_ID,
    ...
    assertThat(got, anyOf(containsString("アカウント"), containsString("口座")));
  }
}