...
public class TranslateV3TranslateTextWithGlossaryAndModel {
   ...
   */
  public static void sampleTranslateTextWithGlossaryAndModel(
      String modelId,
      String glossaryId,
      String text,
  ...
  public static void main(String[] args) throws Exception {
    ...
    sampleTranslateTextWithGlossaryAndModel(
            modelId, glossaryId, text, targetLanguage, sourceLanguage, projectId, location);
  }
}
