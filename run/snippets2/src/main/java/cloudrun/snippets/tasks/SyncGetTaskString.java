...
// [START cloudrun_Tasks_GetTask_String_sync]
...
public class SyncGetTaskString {
  ...
  public static void main(String[] args) throws IOException {
    ...
    syncGetTaskString(projectId, location);
  }

  public static void syncGetTaskString(String projectId, String location) throws IOException {

    try (TasksClient tasksClient = TasksClient.create()) {
      String name =
          TaskName.of(projectId, location, "[JOB]", "[EXECUTION]", "[TASK]").toString();
      Task response = tasksClient.getTask(name);
    }
  }
}
// [END cloudrun_Tasks_GetTask_String_sync]
