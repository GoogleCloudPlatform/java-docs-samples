...
// [START cloudrun_Jobs_CreateJob_sync]
...
public class SyncCreateJob {
  ...
  public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
    ...
    syncCreateJob(projectId, location);
  }

  public static void syncCreateJob(String projectId, String location) throws IOException, InterruptedException, ExecutionException {
...
// [END cloudrun_Jobs_CreateJob_sync]
