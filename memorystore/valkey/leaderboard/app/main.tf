...
resource "google_compute_network" "app_network" {
  name = "leaderboard-app-network"
}

resource "google_compute_firewall" "allow_http" {
  name    = "leaderboard-app-allow-http-8080"
...
module "valkey" {
  ...
  instance_id    = "leaderboard-app-valkey-instance"
...
resource "google_sql_database_instance" "postgres" {
  name             = "leaderboard-app-postgres-instance"
