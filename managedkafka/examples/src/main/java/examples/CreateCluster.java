...
public class CreateCluster {
    ...
    public static void createCluster(
            String projectId, String region, String clusterId, String subnet,
            int cpu, long memoryBytes)
            throws Exception {
        CapacityConfig capacityConfig = CapacityConfig.newBuilder()
                .setVcpuCount(cpu)
        ...
        NetworkConfig networkConfig = NetworkConfig.newBuilder()
                .setSubnet(subnet)
                .build();
        GcpConfig gcpConfig = GcpConfig.newBuilder()
                .setAccessConfig(AccessConfig.newBuilder()
                        .addNetworkConfigs(networkConfig).build())
                .build();
        RebalanceConfig rebalanceConfig = RebalanceConfig.newBuilder()
