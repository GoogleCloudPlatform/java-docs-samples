...
public class DeleteConsumerGroup {
    ...
    public static void deleteConsumerGroup(
            String projectId, String region, String clusterId, String consumerGroupId)
            throws Exception {
        try (ManagedKafkaClient managedKafkaClient = ManagedKafkaClient.create()) {
            managedKafkaClient.deleteConsumerGroup(ConsumerGroupName.of(projectId, region, clusterId, consumerGroupId));
